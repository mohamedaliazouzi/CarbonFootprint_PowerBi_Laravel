...
<div class="app">
    <div class="header">
        ...
        <div class="header-menu">
            ...
            <a class="menu-link notify" href="#">About</a>
            <a class="menu-link" href="#">Services</a>
            <a class="menu-link notify" href="#">Contact Us</a>
        </div>
        ...
        <div class="header-profile">
            <div class="notification">
                ...
                <button class="content-button status-button open">Sign up</button>
                ...
                <div class="content-wrapper-header">
                    <div class="content-wrapper-context">
                        ...
                        <div class="content-text">Grab yourself 10 free images from Adobe Stock in a 30-day free
                            trial plan and find perfect image, that will help you with your new project.
                        </div>
